...
// NetworkV1alpha1Client is used to interact with features provided by the network.tmaxanc.com group.
type NetworkV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkV1alpha1Client) FloatingIPs(namespace string) FloatingIPInterface {
	return newFloatingIPs(c, namespace)
}

func (c *NetworkV1alpha1Client) PublicIPPools() PublicIPPoolInterface {
	return newPublicIPPools(c)
}
